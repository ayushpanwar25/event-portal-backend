...
import AdminAuthenticationRouter from "./routes/admin/AdminAuthentication.js";

import FacultyDSWRegisterRouter from "./routes/admin/FacultyDSW.js";
...
const main = async () => {
  ...
  app.use(express.urlencoded({ extended: true }));
	...
	app.use("/api/admin/auth", AdminAuthenticationRouter);
	app.use("/api/admin/register", FacultyDSWRegisterRouter);
